 ...
 */
public class CassandraClient105 extends DB
{
	...
	{
		CassandraClient105 cli = new CassandraClient105();

		Properties props = new Properties();

		props.setProperty("hosts", args[0]);
		props.setProperty(COLUMN_FAMILY_PROPERTY, "cf2");
		...
		int res = cli.insert("usertable", "cf2", vals);
		...
		res = cli.read("usertable", "cf2", null, result);
